package {
	...
	public class Bullet extends MovieClip {
		...
		private var _dy:int;// ^ just in y direction
		private var SPEED:Number = 15; //speed of the bullet
		...
		//bullet constructor
		public function Bullet(xPos:int, yPos:int, xGo:int, yGo:int) {
		...
		public function moveBullet():void {
			...
			//if the bullet has moved off the top of the stage, destroy it
